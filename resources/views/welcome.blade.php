				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-between">
						<div class="col-lg-6 col-md-6 banner-left">
							<h6 class="text-white">Away from stress life</h6>
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="single-destination relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="assets/img-fluid" src="assets/img/d1.jpg" alt="">
								</div>
								<div class="desc">	
						...
						<div class="col-lg-4">
							<div class="single-destination relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="assets/img-fluid" src="assets/img/d2.jpg" alt="">
								</div>
								<div class="desc">	
						...
						<div class="col-lg-4">
							<div class="single-destination relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="assets/img-fluid" src="assets/img/d3.jpg" alt="">
								</div>
								<div class="desc">	
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-other-issue">
								<div class="thumb">
									<img class="assets/img-fluid" src="assets/img/o2.jpg" alt="">					
								</div>
								<a href="#">
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-other-issue">
								<div class="thumb">
									<img class="assets/img-fluid" src="assets/img/o3.jpg" alt="">					
								</div>
								<a href="#">
									<h4>To Do List</h4>
								</a>
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-other-issue">
								<div class="thumb">
									<img class="assets/img-fluid" src="assets/img/o4.jpg" alt="">					
								</div>
								<a href="#">
									<h4>Food Features</h4>
								</a>
					...
					<div class="row">
						<div class="active-recent-blog-carusel">
							<div class="single-recent-blog-post item">
								<div class="thumb">
									<img class="assets/img-fluid" src="assets/img/b1.jpg" alt="">
								</div>
								<div class="details">
									<div class="tags">
										<ul>
							...
							<div class="single-recent-blog-post item">
								<div class="thumb">
									<img class="assets/img-fluid" src="assets/img/b2.jpg" alt="">
								</div>
								<div class="details">
									<div class="tags">
										<ul>
							...
							<div class="single-recent-blog-post item">
								<div class="thumb">
									<img class="assets/img-fluid" src="assets/img/b3.jpg" alt="">
								</div>
								<div class="details">
									<div class="tags">
										<ul>
